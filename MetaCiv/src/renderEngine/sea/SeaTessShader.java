...
public class SeaTessShader extends ShaderTessProgram {

	private final static String VERTEX_FILE = "/renderEngine/sea/seaTessVertex.glsl";
	private final static String FRAGMENT_FILE = "/renderEngine/sea/seaTessFragment.glsl";
	private static final String TESS_CONTROL_FILE = "/renderEngine/sea/seaTesstcsShader.glsl";
	private static final String TESS_EVALUATION_FILE = "/renderEngine/sea/seaTesstesShader.glsl";
