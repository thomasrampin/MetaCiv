...
public class A_GoToTarget extends Action{
	...
	public String getInfo() {
		return super.getInfo() + " send the agent to the target patch that was set by setTarget* functions.<html>";
	}

	
	public ArrayList<Patch> AStar(Human h,Patch cible)
	{
