...
public class PanelObjets extends JPanel implements ActionListener{
	...
	public PanelObjets (PanelModificationSimulation panelParent , PanelListeObjets panelListeObjets){
		...
		TitledBorder bordure = BorderFactory.createTitledBorder(BorderFactory.createLoweredBevelBorder(), I18nList.CheckLang("Item editor"));
		...
		name = new JLabel(I18nList.CheckLang("Item name : "));
		...
		descriptionField.setText(I18nList.CheckLang("Enter item Description here"));
		...
		this.saveObject = new JButton(I18nList.CheckLang("save object"));
	...
	//	System.out.println(e.getActionCommand() );
		...
		if(e.getActionCommand() == "Ardy")
		{
			...
			for(int i = 0; i < this.effects.size();++i)
			{
				test = !this.effects.get(i).getName().equals(ef.getName());
			}
			if(test)
			{
				this.effects.add( new PanelEffect(this,ef) );
