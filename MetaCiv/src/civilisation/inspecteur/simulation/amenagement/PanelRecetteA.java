...
public class PanelRecetteA extends JPanel implements ActionListener{
	...
	PanelAmenagement sup;
	String tempo = "bla";
	public PanelRecetteA(PanelAmenagement objet)
	{
		super();
		sup = objet;
	...
	public void update(PanelAmenagement objet)
	{
