...
public class PanelEffectA extends JPanel implements ActionListener{
	...
	public PanelEffectA(PanelAmenagement panelParent)
	{
		super();
		...
		choix3T = new JRadioButton(I18nList.CheckLang("Objets"));
		choix4T = new JRadioButton(I18nList.CheckLang("Ressource/tick"));
		...
		choix3T.setActionCommand("Objets");
		choix4T.addActionListener(this);
		choix4T.setActionCommand("Ressources/tick");
		choixTarget.add(choix1T);
		choixTarget.add(choix2T);
		choixTarget.add(choix3T);
		choixTarget.add(choix4T);
	...
	public PanelEffectA(PanelAmenagement p,Effect e)
	{
		super();
		...
		choix2T = new JRadioButton(I18nList.CheckLang("Cognitons"));
		choix3T = new JRadioButton(I18nList.CheckLang("Objets"));
		choix4T = new JRadioButton(I18nList.CheckLang("Ressources/tick"));
		...
		else  if(e.getTarget().equals("objet"))
		{
			choix3T.setSelected(true);
		}
		else
		{
			choix4T.setSelected(true);
		}
		...
		else if(e.getTarget().equals("objet"))
		{
			...
			{
				listeCibles.addItem(Configuration.objets.get(i).getNom());
			}
		}
		else if(e.getTarget().equals("ressource"))
		{
			for(int i = 0; i < Configuration.itemsPheromones.size();++i)
			{
				listeCibles.addItem(Configuration.itemsPheromones.get(i).getNom());
			}
		}
		else
		{
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		if(e.getActionCommand() == "SaveEffect")
		{
			...
			else if(choix3T.isSelected())
			{
				ef.setTarget("objet");
			}
			else
			{
				ef.setTarget("Ressources/tick");
			}
		...
		else if(e.getActionCommand() == "Attributes" || e.getActionCommand() == "Cognitons" || e.getActionCommand() == "Actions" || e.getActionCommand() == "Objets"|| e.getActionCommand() == "Ressources/tick")
		{
			if(choix1T.isSelected())
			{
