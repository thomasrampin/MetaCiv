...
public class PanelGroupTree  extends JJPanel{
	...
	public void addNewGroup() {
		Configuration.getSchemaCognitifEnCourEdition().getGroups().add(new GroupModel("new_group_model"+Configuration.getSchemaCognitifEnCourEdition().getGroups().size()));
	...
	public void refresh()
	{
		...
		groupTree.setBackground(this.getBackground());
		this.add(groupTree , BorderLayout.CENTER);
		//((GroupTreeModel)groupTree.getModel()).refresh();
	}
