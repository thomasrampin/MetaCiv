...
public class PanelListeCivilisations extends JJPanel{
	...
	JList<Civilisation> listeCivilisations;
	DefaultListModel<Civilisation> listModel;
	...
	public void setListeCivilisations(JList<Civilisation> listeCivilisations) {
		this.listeCivilisations = listeCivilisations;
	}

	public void addCivilization(Civilisation c) {
		((javax.swing.DefaultListModel<Civilisation>)listeCivilisations.getModel()).addElement(c);			
	}
	...
	private void setupList() {
		...
		listModel = new DefaultListModel<Civilisation>();
		listeCivilisations = new JList<Civilisation>(listModel);
