...
public class DialogCreatePheromon extends JDialog implements ActionListener, PropertyChangeListener{
	...
	public DialogCreatePheromon(Frame f , boolean modal, Terrain terrain)
	{
		...
		labelName = new JLabel(I18nList.CheckLang("Attribute Name : "));
		nom = new JTextField();
		labelStart = new JLabel(I18nList.CheckLang("Start Value : "));
		start = new JTextField();
		labelGrowth = new JLabel(I18nList.CheckLang("Growing value (units/tick) : "));
